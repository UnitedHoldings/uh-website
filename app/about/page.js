...
export default function About() {
    return (
        <div className="min-h-screen font-outfit mx-auto">
            ...
            <div className='w-full bg-[#9b1c20] py-8 mb-8'>
            <div className='max-w-[1400px]  px-4   space-y-6 mx-auto'>
                <div className="flex   justify-between items-center md:flex-row md:items-center gap-4 md:gap-8">
                    <p className='max-w-[800px] text-white text-2xl'>Most claims, including home, life, funeral, vehicles can be taken care of in <span className="hover:underline cursor-pointer font-semibold">My Account</span> . Check out the information below for other claims that are handled a little differently.</p>
                    <div>
                        <button className='border-white border  text-white py-2 px-8 rounded-full' >
                            Client Area
                        </button>
                    </div>
                </div>
            ...
            <main className=" px-4 py-12 bg-[#9b1c20] mb-16">
                ...
                <section className="  max-w-[1400px] mx-auto  rounded-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className=" overflow-hidden">
                            <div className="h-60 w-full rounded-2xl relative bg-white flex items-center justify-center px-16">
                        ...
                        <div className="   sh overflow-hidden">
                            <div className="h-60 w-full rounded-2xl relative bg-white flex items-center justify-center px-16">
