    ...
    <html lang="en">
      <body className={`${outfit.variable} font-outfit  antialiased relative`}>
        ...
        <a
          ...
          className="fixed left-6 bottom-6 z-50 flex text-sm items-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white px-4 py-2 rounded-full shadow-lg transition-colors duration-200"
        >
