                ...
                <div className="flex flex-col gap-4 md:gap-16">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
                            ...
                            <div className="text-xl sm:text-2xl md:text-3xl max-w-3xl text-white">
                                <p>
                                    <span className="text-white">United Holding</span> has a solution for individuals, families & teams. Find the{' '}
                                    <span className="text-white">product</span> that you need.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="hidden md:flex gap-2 mt-4 md:mt-0">
                            <button
                                ...
                                className={`p-3 rounded-full border ${isBeginning ? 'text-gray-300 border-gray-200' : 'text-[#9b1c20] border-[#9b1c20] hover:bg-[#9b1c20] hover:text-white'}`}
                            ...
                            <button
                                onClick={scrollNext}
                                disabled={isEnd}
                                className={`p-3 rounded-full border ${isEnd ? 'text-gray-300 border-gray-200' : 'text-[#9b1c20] border-[#9b1c20] hover:bg-[#9b1c20] hover:text-white'}`}
