...
const ALLOWED_EMPLOYEES = [
  ...
  { name: "SIMEON SIMELANE", email: "IAmanager@united.co.sz", position: "GROUP INTERNAL AUDIT MANAGER" },
  ...
  { name: "MHLONIPHENI MASILELA", email: "gr.assistantMM@united.co.sz", position: "ACTING MARKETING MANAGER" },
  ...
  { name: "GCINILE MOTSA", email: "marketingcommofficer@united.co.sz", position: "MARKETING AND COMMS OFFICER" },
  { name: "ZANDILE MATSEJWA", email: "adminassistant3@united.co.sz", position: "ADMINISTRATIVE ASSISTANT" },
  ...
  { name: "SIMANGELE DLAMINI", email: "ugiundersupervisor@united.co.sz", position: "UNDERWRITING SUPERVISOR" },
  { name: "MFANAFUTHI SIMELANE", email: "ulaunderwriter1@united.co.sz", position: "ULA UNDERWRITING OFFICER" },
  { name: "LUNGILE MNGOMETULU", email: "ulaclaimsofficer3@united.co.sz", position: "CLAIMS OFFICER" },
