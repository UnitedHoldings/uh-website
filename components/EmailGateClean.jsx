...
const ALLOWED_EMPLOYEES = [
  { name: "LUNGILE NGVKENYA", email: "csrmanager@united.co.sz", position: "CORPORATE SALES & RETENTION MANAGER" },
  { name: "LOVEMORE GUNDANI", email: "ugimanager@united.co.sz", position: "UGI OPERATIONS MANAGER" },
  { name: "SEBENELE ZWANE", email: "ugmanager@united.co.sz", position: "UP OPERATIONS MANAGER" },
  { name: "SHILE DIAMINI", email: "ulamanager@united.co.sz", position: "ULA OPERATIONS MANAGER" },
  { name: "WHILE SIBANDZE", email: "co.secandlegal@united.co.sz", position: "GROUP COMPANY SECRETARY & LEGAL" },
  ...
  { name: "THABANI DIAMINI", email: "financeofficer1@united.co.sz", position: "FINANCE OFFICER" },
  ...
  { name: "ZANDILE MATSEJWA", email: "administstant3@united.co.sz", position: "ADMINISTRATIVE ASSISTANT" },
  { name: "THANDAZILE MAHLALEJA", email: "administstant2@united.co.sz", position: "ADMINISTRATIVE ASSISTANT" },
  ...
  { name: "SIMANGELE DIAMINI", email: "uglundersupervisor@united.co.sz", position: "UNDERWRITING SUPERVISOR" },
